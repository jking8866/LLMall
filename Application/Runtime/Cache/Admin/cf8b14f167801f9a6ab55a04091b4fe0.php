                 ...
                 <thead>
                    ...
                    <tbody>
								<?php if(is_array($ClazzList)): $i = 0; $__LIST__ = $ClazzList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$bean): $mod = ($i % 2 );++$i;?><tr>
									...
									<td>
									 <a href="/LLMall/admin.php/Clazz/edit/clazz_id/<?php echo ($bean["id"]); ?>"  >编辑</a>
									 <a href="/LLMall/admin.php/Clazz/updateClazzState/clazz_id/<?php echo ($bean["id"]); ?>"  >开课</a>
...
function ajax_getBeanInfo(bean_id){
	...
	$.ajax({
		type: "get",
		url : "/LLMall/admin.php/Course/ajax_getBeanInfo",
        ...
        <div class="tab-content">
          ...
          <div class="tab-pane active" id="control-sidebar-home-tab">
            <h5 class="control-sidebar-heading">修改信息</h5>
             <form role="form" method="post" action="/LLMall/admin.php/Course/update">
