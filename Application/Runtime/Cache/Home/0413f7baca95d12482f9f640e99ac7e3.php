...
<html>
  <head>
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="/LLMall/Public/lte/plugins/iCheck/square/blue.css">
  ...
  <body class="hold-transition login-page">
    <div class="login-box">
      ...
      <div class="login-box-body">
        <p class="login-box-msg">请填写用户名和密码</p>
        <form action="/LLMall/Login/loginCheck" method="post">
...
<!--         <a href="register.html" class="text-center">Register a new membership</a> -->
    ...
    <!-- iCheck -->
    <script src="/LLMall/Public/lte/plugins/iCheck/icheck.min.js"></script>
    <script>
      $(function () {
        $('input').iCheck({
