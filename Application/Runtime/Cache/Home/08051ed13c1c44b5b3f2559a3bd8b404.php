    ...
    <div class="row">
      <div class="col-md-6">
              ...
              <div class="box box-primary">
                ...
                <!-- form start -->
                <form role="form" method="post" action="/zy/Student/insert">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      <label for="student_school_name">所在学校</label>
                    ...
                    <div class="form-group">
                      <label for="student_grade_num">年级</label>
                     	<select class="form-control"  name="student_grade_num" >
                    ...
                    <div class="form-group">
                      <label for="wx_username">微信端账号</label>
                      <input type="text" class="form-control" name="wx_username" id="wx_username" placeholder="">
                    </div>
                    <div class="form-group">
                      <label for="student_parent_phone_num1">联系人电话-1</label>
                      <input type="text" class="form-control" name="student_parent_phone_num1" id="student_parent_phone_num1" placeholder="">
                    </div>
                    <div class="form-group">
                      <label for="student_parent_phone_num2">联系人电话-2</label>
                      <input type="text" class="form-control" name="student_parent_phone_num2" id="student_parent_phone_num2" placeholder="">
                    </div>
                    <div class="form-group">
                      <label for="student_parent_phone_num3">联系人电话-3</label>
