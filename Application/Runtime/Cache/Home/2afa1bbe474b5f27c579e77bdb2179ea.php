			...
			<div class="col-md-6">
				...
				<div class="box box-primary">
					<div class="box-header with-border">
						<h3 class="box-title">缴费</h3>
					</div>
					<!-- /.box-header -->
					<!-- form start -->
					<form role="form" method="post" action="/zy/Order/insertPayCost">
						<input type="hidden" name="id"  value="<?php echo ($order_id); ?>"  >
						<input type="hidden" name="clazz_type"  value="<?php echo ($clazz_type); ?>"  >
						<div class="box-body">
							<div class="form-group">
								<label for="add_sign_up_cost">金额</label> 
								<input type="number" min="0" max="<?php echo ($pay_max); ?>" class="form-control" name="add_sign_up_cost" id="add_sign_up_cost" placeholder="还应缴纳<?php echo ($pay_max); ?>元">
							</div>
						</div>
						<!-- /.box-body -->
