                 ...
                 <thead>
                    ...
                    <tbody>
								<?php if(is_array($OrderList)): $i = 0; $__LIST__ = $OrderList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$bean): $mod = ($i % 2 );++$i;?><tr>
									...
									<td>
									 	<a href="/zy/Order/payOrderCost/order_id/<?php echo ($bean["order_id"]); ?>/clazz_type/1"  >缴费</a>
									</td>
        ...
        <div class="tab-content">
          ...
          <div class="tab-pane active" id="control-sidebar-home-tab">
            <h5 class="control-sidebar-heading">修改信息</h5>
             <form role="form" method="post" action="/zy/Course/update">
