...
<!--                 </div>/.box-header -->
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
								<?php if(is_array($StudentList)): $i = 0; $__LIST__ = $StudentList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$bean): $mod = ($i % 2 );++$i;?><tr>
									<td><?php echo ($bean["student_num"]); ?></td>
									<td><?php echo ($bean["student_name"]); ?></td>
									<td>
								    <?php switch($bean["student_grade_num"]): case "1": ?>一年级<?php break;?>
				                        	<?php case "2": ?>二年级<?php break;?>
				                        	<?php case "3": ?>三年级<?php break;?>
				                        	<?php case "4": ?>四年级<?php break;?>
				                        	<?php case "5": ?>五年级<?php break;?>
				                        	<?php case "6": ?>六年级<?php break;?>
				                        	<?php case "7": ?>初一<?php break;?>
				                        	<?php case "8": ?>初二<?php break;?>
				                        	<?php case "9": ?>初三<?php break;?>
				                        	<?php case "10": ?>高一<?php break;?>
				                        	<?php case "11": ?>高二<?php break;?>
				                        	<?php case "12": ?>高三<?php break; endswitch;?>
									
									 </td>
									<td><?php echo ($bean["student_school_name"]); ?></td>
									<td><?php echo ($bean["student_parent_phone_num1"]); ?></td>
									<td>
									 <a href="#" data-toggle="control-sidebar" onclick="ajax_getStudentInfo(<?php echo ($bean["id"]); ?>)">编辑</a>
...
function ajax_getStudentInfo(student_id){
	 $('#student_id').val("");
	 $('#student_name').val("");
	 $('#student_grade_num').val("");
	 $('#student_school_name').val("");
	 $('#student_parent_phone_num1').val("");
	 $('#student_parent_phone_num2').val("");
	 $('#student_parent_phone_num3').val("");
	...
	$.ajax({
		...
		success : function( obj ){
			 ...
			 $('#student_grade_num').val(obj.student_grade_num);
			 $('#student_school_name').val(obj.student_school_name);
			 $('#student_parent_phone_num1').val(obj.student_parent_phone_num1);
			 $('#student_parent_phone_num2').val(obj.student_parent_phone_num2);
			 $('#student_parent_phone_num3').val(obj.student_parent_phone_num3);
		},
...
function ajax_updateStudentInfo(){
	 var student_id = $('#student_id').val();
	 var student_name = $('#student_name').val();
	 var student_grade_num = $('#student_grade_num').val();
	 var student_school_name = $('#student_school_name').val();
	 var student_parent_phone_num1 = $('#student_parent_phone_num1').val();
	 var student_parent_phone_num2 = $('#student_parent_phone_num2').val();
	 var student_parent_phone_num3 = $('#student_parent_phone_num3').val();
	$.ajax({
		type: "get",
		url : "/zy/Student/ajax_updateStudentInfo",
		data :  {"student_id":student_id,
				 "student_name":student_name,
				 "student_grade_num":student_grade_num,
				 "student_school_name":student_school_name,
				 "student_parent_phone_num1":student_parent_phone_num1,
				 "student_parent_phone_num2":student_parent_phone_num2,
				 "student_parent_phone_num3":student_parent_phone_num3},
		dataType : "json",
        ...
        <div class="tab-content">
          ...
          <div class="tab-pane active" id="control-sidebar-home-tab">
            <h5 class="control-sidebar-heading">修改信息</h5>
             <form role="form" method="post" action="/zy/Student/update">
                  ...
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      <label for="student_grade_num">年级</label>
<!--                       <input type="text" class="form-control"  name="student_grade_num" id="student_grade_num" placeholder=""> -->
                      <select class="form-control"  name="student_grade_num" id="student_grade_num">
                    ...
                    <div class="form-group">
                      <label for="student_school_name">学校</label>
                      <input type="text" class="form-control" name="student_school_name"  id="student_school_name" placeholder="">
                    </div>
                     
                    <div class="form-group">
                      <label for="student_parent_phone_num1">联系电话-1</label>
                      <input type="text" class="form-control" name="student_parent_phone_num1"  id="student_parent_phone_num1" placeholder="">
                    </div>
                    <div class="form-group">
                      <label for="student_parent_phone_num2">联系电话-2</label>
                      <input type="text" class="form-control" name="student_parent_phone_num2"  id="student_parent_phone_num2" placeholder="">
                    </div>
                    <div class="form-group">
                      <label for="student_parent_phone_num3">联系电话-3</label>
                      <input type="text" class="form-control" name="student_parent_phone_num3"  id="student_parent_phone_num3" placeholder="">
                    </div>
                     
                     <a href="#" class="btn btn-primary" data-toggle="control-sidebar" onclick="ajax_updateStudentInfo()">提交</a>
                  </div><!-- /.box-body -->
                </form>
