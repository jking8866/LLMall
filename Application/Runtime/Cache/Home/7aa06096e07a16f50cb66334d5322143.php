    ...
    <div class="row">
      <div class="col-md-6">
              ...
              <div class="box box-primary">
                ...
                <!-- form start -->
                <form role="form" method="post" action="/zy/Personnel/insert">
                  <div class="box-body">
                    <div class="form-group">
                      <label for="student_name">教务老师姓名</label>
                      <input type="text" class="form-control" name="personnel_name" id="personnel_name" placeholder="">
                    </div>
                     <div class="form-group">
                      <label for="wx_username">教务老师性别</label>
		               <div class="radio">
							<label  class="radio-inline">
							<input id="optionsRadios1" type="radio" checked="" value="1" name="personnel_sex"> 男
							</label>
							<label class="radio-inline">
							<input id="optionsRadios1" type="radio" value="2" name="personnel_sex"> 女
							</label>
						</div>
                    </div>
                    <div class="form-group">
                      <label for="student_school_name">教务老师联系方式</label>
                      <input type="text" class="form-control" name="personnel_tel_num" id="personnel_tel_num" placeholder="">
                    </div>
                   
                    <div class="form-group">
                      <label for="student_parent_phone_num1">备注</label>
                     <textarea class="form-control" placeholder="" rows="3" name="personnel_remark" id="personnel_remark"></textarea>
                    </div>
                  </div><!-- /.box-body -->
