			...
			<div class="col-md-12">
				...
				<div class="nav-tabs-custom">
					<ul class="nav nav-tabs">
						...
						<li class="active"><a href="#tab_3" data-toggle="tab">一对一</a></li>
					</ul>
							...
							<div class="row">
								<div class="col-md-6">
									...
									<div class="">
										...
										<!-- /.box-header -->
										<!-- form start -->
										<form role="form" method="post" action="/zy/Order/insertClazzOne">
											<div class="box-body">
...
function getOrderInfo(){
	...
	$.ajax({
		type: "get",
		url : "/zy/CostOne/ajax_getCostOneInfo",
		data :  {"grade_id":$("#grade_id").val(),"teacher_level":$("#teacher_level").val(),"hour_count":$("#hour_count").val()},
		dataType : "json",
		async: false,
		success : function( obj ){
